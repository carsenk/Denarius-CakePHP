...
This Plugin is mainly for Denarius Transactions. I tried to include some other Payment methods. But this is incomplete at the moment.
<br />Planned: Paypal, Paysafe, ...

<h3>Quick-Start Guide</h3>
@see README or my <a href="http://www.dereuromark.de/2011/07/20/denariuss-and-cakephp/" target="_blank">BLOG</a>.
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Denarius Admin Center'), array('plugin'=>'payment', 'controller'=>'denarius', 'action'=>'index'))?></li>
		<li><?php echo $this->Html->link(__('Denarius Addresses'), array('plugin'=>'payment', 'controller'=>'denarius_addresses', 'action'=>'index'))?></li>
		<li><?php echo $this->Html->link(__('Denarius Transactions'), array('plugin'=>'payment', 'controller'=>'denarius_transactions', 'action'=>'index'))?></li>
